angular.module('libraryOrganizer', ['ngMaterial', 'ng-fusioncharts'])
    ...
    .controller('libraryOrganizerController', function($scope, $http, $timeout, $mdSidenav, $mdDialog) {
        ...
        $scope.updateState = function() {
            var url = location.protocol + "//" + location.host + location.pathname + $.param($scope.params);
        ...
        window.onpopstate = function(e) {
            if (e.stste) {
                document.getElementById("maincontent").innerHTML = e.state.html;
            }
        }
    })
